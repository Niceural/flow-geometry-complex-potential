...
output_folder = "./data/example4/" # folder where the plots and results will be saved
flow_elements_file = "./data/example4/flow_elements.csv" # file declaring the flow elements
...
if trajectoryPlot:
    ...
    plot.animated_trajectory(flow, out.y, file_name=os.path.join(output_folder, "animated_trajectory.gif"), plot_title="Leapfrogging of Four Vortices")
