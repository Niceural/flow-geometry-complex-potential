...
output_folder = "./data/example1/" # folder where the plots and results will be saved
flow_elements_file = "./data/example1/flow_elements.csv" # file declaring the flow elements
