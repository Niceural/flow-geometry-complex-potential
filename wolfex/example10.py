...
output_folder = "./data/example10/" # folder where the plots and results will be saved
flow_elements_file = "./data/example10/flow_elements.csv" # file declaring the flow elements
