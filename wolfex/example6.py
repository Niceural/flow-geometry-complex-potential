"""
Example 6: Collapse Expansion of Three Vortices
###############################################

In this example we will simulate the collapse expansion of three vortices
...
output_folder = "./data/example6/" # folder where the plots and results will be saved
flow_elements_file = "./data/example6/flow_elements.csv" # file declaring the flow elements
